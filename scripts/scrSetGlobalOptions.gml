...
global.roomCaptionDef = "I wanna be the guy";  //sets default window caption (only works with the Professional version of Studio)
global.version = "Ver 0.0.1 GMS Edition";
...
global.startRoom = rARoom1;    //sets which room to begin with
