///scrSaveGamePlus(saveposition, savebackground)
///saves the game
...
var saveBackground = argument1;

scrLoadGameInformation(true);
...
//global.savedBackgroundIndex = global.backgroundIndex;
...
//add the background visible type of the room
if (saveBackground)
    global.savedBackgroundIndex = global.backgroundIndex;

ds_map_add(saveMap, "backgroundIndex" , global.savedBackgroundIndex);
